...
$translations = [
	...
	"br" => [ utf8_decode("Finalizado há %a dias, %H horas e %i minutos.")     , utf8_decode("%a dias, %H horas e %i minutos restantes.")    ],
	"es" => [ utf8_decode("Finalizó hace %a días, %H horas y %i minutos.")     , utf8_decode("Quedan %a días, %H horas y %i minutos.")       ],
	"fr" => [ utf8_decode("Terminé depuis %a jours, %H heures et %i minutes.") , utf8_decode("%a jours, %H heures et %i minutes restantes.") ],
